      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-[101] max-h-[80vh] overflow-hidden"
          >
            <div className="p-5">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6 max-h-[50vh] overflow-y-auto">
                ...
                <motion.button
                  ...
                  className="aspect-[5/6] rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-2 hover:border-primary hover:bg-primary/5 transition-colors"
                >
...
function TagCard({ tag, isSelected, onClick }: TagCardProps) {
  return (
    <motion.button
      ...
      onClick={onClick}
      className={`
        aspect-[5/6] rounded-2xl flex flex-col items-center justify-center gap-2 relative
