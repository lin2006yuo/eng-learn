...
export async function articleListCmd(scope, format) {
...
export async function articleCreateCmd(title, summary, content, status, format) {
...
export async function articleGetCmd(id, format) {
...
export async function articleUpdateCmd(id, updates, format) {
...
export async function articleDeleteCmd(id, format) {
